...
const documentRequested = require('./routes/document-requested.js');
...
// Channels
console.log(cyan.bold.inverse(' SUB '), gray('Subscribed to'), yellow('document/requested'));
app.use(documentRequested);
